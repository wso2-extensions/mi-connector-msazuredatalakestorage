...
public class RenameDirectory extends AbstractAzureMediator {
    ...
    public void execute(MessageContext messageContext, String responseVariable, Boolean overwriteBody) {
        ...
        String newDirectoryName = getMediatorParameter(messageContext, AzureConstants.NEW_DIRECTORY_NAME, String.class, false);
        ...
        try {
            ...
            dataLakeDirectoryClient.renameWithResponse(newFileSystemName , newDirectoryName , null , null , timeout != null ? Duration.ofSeconds(timeout.longValue()) : null , null );
