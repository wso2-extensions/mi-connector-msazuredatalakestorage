...
public class ReadFile extends AbstractAzureMediator {
    ...
    public void execute(MessageContext messageContext, String responseVariable, Boolean overwriteBody) {
        ...
        Integer maxRetryRequests = getMediatorParameter(messageContext, AzureConstants.MAX_RETRY_REQUESTS, Integer.class, true);
        ...
        try {
            ...
            dataLakeFileSystemClient.getFileClient(filePath).readWithResponse(
                    outputStream , fileRange , maxRetryRequests != null ? new DownloadRetryOptions().setMaxRetryRequests(maxRetryRequests) : null,
                    null,
                    false,
