...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.azureDataLake;
 ...
 */
public class azureDataLakeConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "azureDataLake test case")
